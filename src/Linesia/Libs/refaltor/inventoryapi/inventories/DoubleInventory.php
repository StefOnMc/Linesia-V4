...
namespace Linesia\Libs\refaltor\inventoryapi\inventories;

use Linesia\Core;
use Linesia\Libs\refaltor\inventoryapi\schedulers\DelayTask;
...
class DoubleInventory extends SimpleChestInventory {
    ...
    public function send(Player $player)
    {
        if (!isset($this->hasSend[$player->getXuid()])) {
            ...
            Core::getInstance()->getScheduler()->scheduleDelayedTask(new DelayTask($player, $this), 20); // Delay for PS4 /!\ and switch GUI use bug.
