...
class AmethysteChestPlate extends Armor {

    public function __construct() {
        parent::__construct(new ItemIdentifier(303,0), "Amethyste ChestPlate", new ArmorTypeInfo(8, 1128, ArmorInventory::SLOT_CHEST));
    }
