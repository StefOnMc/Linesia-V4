...
class AmethysteRenfoChestPlate extends Armor {

    public function __construct() {
        parent::__construct(new ItemIdentifier(315,0), "Amethyste-Renfo ChestPlate", new ArmorTypeInfo(8, 2256, ArmorInventory::SLOT_CHEST));
    }
