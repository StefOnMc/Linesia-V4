...
class AmethysteRenfoLeggings extends Armor {

    public function __construct() {
        parent::__construct(new ItemIdentifier(316,0), "Amethyste-Renfo Leggings", new ArmorTypeInfo(6, 2190, ArmorInventory::SLOT_LEGS));
    }
